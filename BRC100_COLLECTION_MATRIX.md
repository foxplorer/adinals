...
| Image collections, mints, and updates | Indexing proven on real records up to a 187 KB cover and a 107 KB update creative; a large image write on current code is untested, and such a record reserves roughly nineteen thousand satoshis rather than the 200-satoshi floor |
